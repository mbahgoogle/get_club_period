...
CLUB_ALIASES = {
  "1.fc heidenheim 1846": ["heidenheim", "fch", "die rot-weißen", "the red-whites", "heidenheimer sb"],
  "1.fc union berlin": ["union berlin", "die eisernen", "the iron ones", "sc motor berlin", "bsg motor obers."],
...
# Buat file ZIP dari folder 'period'
zip_filename = os.path.join(output_folder, "period_results.zip")
shutil.make_archive(zip_filename.replace(".zip", ""), 'zip', "period")

print(f"\nSaved all results in {zip_filename}")